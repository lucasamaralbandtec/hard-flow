...
public class Tail extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuBar25.add(jMenu52);

        jMenu53.setText("File");
        jMenuBar26.add(jMenu53);

        jMenu54.setText("Edit");
        jMenuBar26.add(jMenu54);

        jMenu55.setText("File");
        jMenuBar27.add(jMenu55);

        jMenu56.setText("Edit");
        jMenuBar27.add(jMenu56);

        jMenu57.setText("File");
        jMenuBar28.add(jMenu57);

        jMenu58.setText("Edit");
        jMenuBar28.add(jMenu58);

        jMenu59.setText("File");
        jMenuBar29.add(jMenu59);

        jMenu60.setText("Edit");
        jMenuBar29.add(jMenu60);

        jMenu61.setText("File");
        jMenuBar30.add(jMenu61);

        jMenu62.setText("Edit");
        jMenuBar30.add(jMenu62);

        jMenu63.setText("jMenu63");
        ...
        jMenuBar32.add(jMenu66);

        jMenu67.setText("Edit");
        jMenuBar32.add(jMenu67);

        jMenu68.setText("jMenu68");

        jMenuItem9.setText("jMenuItem9");

        jMenu69.setText("File");
        jMenuBar33.add(jMenu69);

        jMenu70.setText("Edit");
        jMenuBar33.add(jMenu70);

        jMenu71.setText("File");
        jMenuBar34.add(jMenu71);

        jMenu72.setText("Edit");
        jMenuBar34.add(jMenu72);

        jMenu73.setText("File");
        jMenuBar35.add(jMenu73);

        jMenu74.setText("Edit");
        jMenuBar35.add(jMenu74);

        jMenu75.setText("File");
        jMenuBar36.add(jMenu75);

        jMenu76.setText("Edit");
        jMenuBar36.add(jMenu76);

        jMenu77.setText("File");
        jMenuBar37.add(jMenu77);

        jMenu78.setText("Edit");
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 620, 260));

        jPanel2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jPanel2.setForeground(new java.awt.Color(255, 255, 255));

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\fderivs\\Pictures\\icons8-document-39.png")); // NOI18N
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, 40, 50));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, 70, 30));

        jPanel4.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 19)); // NOI18N
        jLabel5.setText("Markers");
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 310, 90, 30));

        jPanel5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 19)); // NOI18N
        jLabel6.setText("Filter Settings");
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 310, 140, 30));

        jPanel6.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 19)); // NOI18N
        jLabel7.setText("Export Settings");
        ...
        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 310, 160, 30));

        jCheckBox1.setBackground(new java.awt.Color(255, 255, 255));
        jCheckBox1.setText("Use Markers");
        jCheckBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCheckBox1ActionPerformed(evt);
            }
        });
        jPanel1.add(jCheckBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 350, 90, 20));

        jCheckBox2.setBackground(new java.awt.Color(255, 255, 255));
        jCheckBox2.setText("Export");
        jCheckBox2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCheckBox2ActionPerformed(evt);
            }
        });
        jPanel1.add(jCheckBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 340, 130, 40));

        jCheckBox3.setBackground(new java.awt.Color(255, 255, 255));
        jCheckBox3.setText("Use Filters");
        jCheckBox3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCheckBox3ActionPerformed(evt);
            }
        });
        jPanel1.add(jCheckBox3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 350, 100, -1));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 23)); // NOI18N
        jLabel1.setText("HardFlow");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 110, 40));
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        fileChooser.setDialogTitle("Prcoura Arquivo");
